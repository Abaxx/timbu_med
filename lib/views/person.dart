      ...
      body: Column(
        ...
        children: [
          Container(
            child: Column(
              children: [
                Text('Profile',style: TextStyle(fontSize: 20.sp,color: Colors.black),),
                SizedBox(height: 20.h),
                Align(alignment: Alignment.topLeft,child: Text('Client Profile',style: TextStyle(fontSize: 15.sp,color: Colors.black),),),
                SizedBox(height: 10.h)
              ],
            ),
          ),
          SizedBox(height: 150.h,),
          Text('My Profile',style: TextStyle(color: Colors.black,fontSize: 30.sp),),
        ],
      ),
      floatingActionButton: FloatingActionButton.extended(onPressed: (){
        //Navigator.push(context, MaterialPageRoute(builder: (context)=> Cart()));
          ...
          label: Padding(
            ...
            child: Text('Profile',style: TextStyle(color: Colors.white,fontSize: 15.sp),),
          )
      ),
